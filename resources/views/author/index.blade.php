                    ...
                    <tr>
                       @if (count($posts) > 0)
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              <a href="{{ route('author.edit', $post->id) }}" class="btn btn-primary mr-2"><i class="fas fa-edit"></i></a>
                              <form action="{{ route('author.delete', $post->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
